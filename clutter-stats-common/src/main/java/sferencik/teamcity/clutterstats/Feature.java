...
public class Feature {
     ...
     * @return true/false based on the radio-box selection; false even if none of the radio options is selected (which happens after upgrade from plugin versions before 2.0.0)
     */
    ...
    /** Is the "when to measure" radio box checked one way or another? It may not be if someone set up the ClutterStats build feature before v2.0.0.
     *
     * @param params the parameter map from the build feature
